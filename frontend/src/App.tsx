...
import { FolderAnalysis, SystemReport } from "./types";
import { bytesToGB } from "./utils";
import { formatDistanceToNow } from "date-fns";

const navItems = [
  { label: "Smart Scan", icon: Sparkles, active: true },
          ...
          <header className="topbar">
            <div>
              ...
              <p className="subtitle">
                Scan your Mac <span>→</span> Find unnecessary files{" "}
                <span>→</span> Clean it safely.
              </p>
            </div>
